...
const uint8_t wifi_Symbol[33] PROGMEM = { // WIFI symbol
    0x00, 0x00, 0x00, 0x00, 0xF0, 0x0F, 0x1C, 0x38, 0x07, 0x60, 0xE1, 0xC7, 0x78, 0x1E, 0x0C, 0x30,
...
void TFT::Init(IThermostatControl *thermostat) {
   ...
   int xpos = ARROW_X;
   int ypos = ARROW_Y;
   tft.fillTriangle(xpos, ypos,           // peak
...
void TFT::Element(boolean state) { tft.fillCircle(POWER_LED_X, POWER_LED_Y, 8, state ? TFT_RED : TFT_BLACK); }
